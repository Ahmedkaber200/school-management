                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 d-flex">
                            <a href="add_course.php" type="submit" class="btn btn-primary">Add Course</a>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            <?php 
                                                $course = mysqli_query($mysqli, "SELECT * FROM `courses`");
                                                while($showCourses = mysqli_fetch_array($course)){
                                             ?>
                                            <tr>
                                                <th scope="row"><?php echo $showCourses['id']; ?></th>
                                                <td><?php echo $showCourses['name']; ?></td>

                                                <td>
                                                <a href="course_edit.php?id=<?php echo $showCourses['id']; ?>"
                                                    class="listing-buttons-spacing btn btn-outline-success btn-xs"
                                                    title="Edit">
                                                    <i class="fa fa-fw fa-edit"></i>
                                                </a>
                                                <a href="course_delete.php?id=<?php echo $showCourses['id']; ?>"
