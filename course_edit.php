    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
                ...
                $result = mysqli_query($mysqli, "UPDATE courses SET name='$name' WHERE id=$id");
                if(isset($result)){
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="addcourse" id="textsend"
                                                        onkeyup="success()" value="<?php echo $name;?>"
                                                        class="form-control alphabetname" id="exampleInputEmail1"
                                                        placeholder="Enter Class name">
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <button type="submit" name="Update" id="button" class="btn btn-primary">Update</button>
