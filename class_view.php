                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover text-center">
                                        ...
                                        <?php 
                                            $class = mysqli_query($mysqli, "SELECT * FROM `classes`");
                                            while($showClassess = mysqli_fetch_array($class)){
                                        ?>
                                        <tr>
                                            <th><?php echo $showClassess['id']; ?></th>
                                            <td><?php echo $showClassess['name']; ?></td>
                                            <td>
                                                <a href="class_edit.php?id=<?php echo $showClassess['id']; ?>"
                                                    class="listing-buttons-spacing btn btn-outline-success btn-xs"
                                                    title="Edit">
                                                    <i class="fa fa-fw fa-edit"></i>
                                                </a>
                                                <a href="class_delete.php?id=<?php echo $showClassess['id']; ?>"
