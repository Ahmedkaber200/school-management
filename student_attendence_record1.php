                                    ...
                                    <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill"
                                                ...
                                                aria-selected="false">Class Four</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
                                                            ...
                                                            <table id="example2"
                                                                ...
                                                                $attend = $_POST['atten'];
                                                                    foreach($attend as $key => $val){  
                                                                        $result = mysqli_query($mysqli, "INSERT INTO `tbl_attendence`(`role`, `attend`, `stu_id` ,`class_id`) VALUES
                                                                        ('$key','$val','$key', '$classid')");
                                                                    }   
                                                                }
                                                                ?>
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        INNER JOIN classes ON classes.id = class_students.c_id WHERE classes.name = 'Three'");
                                                            ...
                                                            <table id="example2"
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        $res = mysqli_query($mysqli, "SELECT DISTINCT class_students.c_id, users.name, classes.name, users.id
                                                                        FROM class_students INNER JOIN users ON class_students.s_id = users.id
                                                                        INNER JOIN classes ON classes.id = class_students.c_id WHERE classes.name = 'Four'");
                                                                        while ($row = mysqli_fetch_array($res)) {
                                                                            // print_r($att);
                                                                        ?>
                                                                    <tr>
